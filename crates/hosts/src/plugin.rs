...
use std::sync::Arc;
use swoop_core::{ErrorClass, HostError, HttpFailure, Resolved, default_classify};
...
pub trait HostPlugin: Send + Sync {
    ...
    async fn resolve(&self, ctx: &HostCtx, url: &Url, attempt: u32) -> Result<Resolved, HostError>;
