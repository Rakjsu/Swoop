//! Portões da fase 1 que rodam dentro do processo (b, c, d, f) e o básico:
//! baixar com várias conexões, pausar e retomar. O portão (e), que mede
//! tempo, fica sozinho em `slow_connection.rs`.
